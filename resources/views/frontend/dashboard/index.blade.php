...
<div class="row">
    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                <div class="flex-shrink-0 text-white icon-element bg-2">
                ...
                <div class="pl-4">
                    ...
                    <h5 class="pt-2 card-title fs-26">5</h5>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div><!-- end col-lg-4 -->
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                <div class="flex-shrink-0 text-white icon-element bg-3">
                    <svg class="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                            <g>
                                <g>
                                    <g>
                ...
                <div class="pl-4">
                    ...
                    <h5 class="pt-2 card-title fs-26">6</h5>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div><!-- end col-lg-4 -->
        ...
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="pl-4">
                    ...
                    <h5 class="pt-2 card-title fs-26">30,405</h5>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div><!-- end col-lg-4 -->
    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                <div class="flex-shrink-0 text-white icon-element bg-6">
                ...
                <div class="pl-4">
                    ...
                    <h5 class="pt-2 card-title fs-26">289.12</h5>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div><!-- end col-lg-4 -->
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item">
            <div class="card-body">
                <h3 class="pb-4 fs-18 font-weight-semi-bold">Total Sales</h3>
                <canvas id="doughnut-chart"></canvas>
                <div id="legend" class="text-center mt-40px"></div>
            </div>
        </div><!-- end card -->
    </div><!-- end col-lg-4 -->
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item">
            <div class="card-body">
                <h3 class="pb-4 fs-18 font-weight-semi-bold">Net Income</h3>
                <canvas id="bar-chart"></canvas>
                <ul class="text-center chart-legend mt-40px">
    ...
    <div class="col-lg-4">
        <div class="card card-item">
            <div class="card-body">
                <h3 class="pb-4 fs-18 font-weight-semi-bold">Earning by Location</h3>
                <div class="my-course-progress-bar-wrap">
                    <div class="flex-wrap mb-2 d-flex align-items-center position-relative">
        ...
        <div class="card card-item">
            <div class="card-body">
                <div class="pb-4 d-flex justify-content-between align-items-center">
                    <h3 class="pb-4 fs-18 font-weight-semi-bold">Earning Statistics</h3>
        ...
        <div class="card card-item">
            <div class="card-body">
                <div class="pb-4 d-flex justify-content-between align-items-center">
                    ...
                    <span class="cursor-pointer fs-15">Mark all as read</span>
                </div>
                <div class="notification-body scrolled-box custom-scrollbar-styled">
                    ...
                    <a href="dashboard.html" class="media media-card align-items-center">
                        <div class="flex-shrink-0 mr-3 text-white icon-element icon-element-sm bg-4">
                            <i class="la la-lock"></i>
                        </div>
                        <div class="media-body">
                            <h5 class="fs-15">You changed password</h5>
                    ...
                    <a href="dashboard.html" class="media media-card align-items-center">
                        <div class="flex-shrink-0 mr-3 text-white icon-element icon-element-sm bg-5">
                            <i class="la la-user"></i>
                        </div>
                        <div class="media-body">
                            <h5 class="fs-15">Your account has been created successfully</h5>
                    ...
                    <a href="dashboard.html" class="media media-card align-items-center">
                        <div class="flex-shrink-0 mr-3 text-white icon-element icon-element-sm bg-6">
                    ...
                    <a href="dashboard.html" class="media media-card align-items-center">
                        <div class="flex-shrink-0 mr-3 text-white icon-element icon-element-sm bg-7">
