                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <ul class="cart-dropdown-menu after-none">
                                                    ...
                                                    <li>
                                                        <a href="my-courses.html" class="btn theme-btn w-100">Got to my course <i class="ml-1 la la-arrow-right icon"></i></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                                        ...
                                                        <ul class="generic-list-item">
                                                            <li>
                                                                <a href="my-courses.html">
                                                                    <i class="mr-1 la la-file-video-o"></i> My courses
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="shopping-cart.html">
                                                                    <i class="mr-1 la la-shopping-basket"></i> My cart
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="my-courses.html">
                                                            ...
                                                            <li>
                                                                <a href="dashboard.html">
                                                                    ...
                                                                    <span class="p-1 ml-2 text-white badge bg-info">9+</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="dashboard-message.html">
                                                                    <i class="mr-1 la la-envelope"></i> Messages
                                                                    <span class="p-1 ml-2 text-white badge bg-info">12+</span>
                                                                </a>
                                                            </li>
                                                            <li><div class="section-block"></div></li>
                                                            <li>
