        ...
        <div class="row pt-50px">
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <form method="post" class="row" action="{{route('become.instructor.register')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="username" placeholder="e.g. Smith">
                                    <span class="la la-user input-icon"></span>
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box col-lg-6">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control" type="password" name="password">
                                </div>
                            </div><!-- end input-box -->
